...
from django.forms import (FileInput, ModelForm, RegexField, Textarea,
...
class TextDatalistInput(TextInput):
    ...
    def get_context(self, name, value, attrs):
        ...
        context['widget']['attrs']['list'] = context['widget']['attrs']['id']+'_datalist'
        return context
...
class ItemImageInline(InlineFormSetFactory):
    ...
    description_defaults = [
        'Price label', 'Packaged', 'Single item (unpacked)']
    ...
    factory_kwargs = {
        ...
        'widgets': {
            ...
            'description': TextDatalistInput(
                options=description_defaults)
            }
    }
